...
strRunActionStatus = "9999"
strRunActionStatus = RunAction ("Add_To_Favorites_By_Icon [(WorkoutVideos) Reusable Actions]", oneIteration, Parameter("strIconColor"), Parameter("strBorderColor"), Parameter("intVieoLinkOrder"))
If (StrComp(strRunActionStatus, "0", 1) <> 0) Then
